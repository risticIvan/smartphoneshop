namespace SmartphoneShop.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        OS = c.String(nullable: false, maxLength: 30),
                        ScreenDiagonal = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Chipset = c.String(nullable: false, maxLength: 50),
                        Ram = c.Decimal(nullable: false, precision: 18, scale: 2),
                        FrontCamera = c.Decimal(nullable: false, precision: 18, scale: 2),
                        BackCamera = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Smartphones", "ShopId", "dbo.Shops");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Smartphones", new[] { "ShopId" });
